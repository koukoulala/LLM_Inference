...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, required=True, default="/data/xiaoyukou/LLM_Inference/output/Mistral-7B-orpo-2/", help="The path of the original model.")
    parser.add_argument("--quant_path", type=str, required=True, default="/data/xiaoyukou/LLM_Inference/output/Mistral-7B-orpo-2-gptq/", help="The path to save the quantized model.")
    parser.add_argument("--test_data", type=str, required=True, default="/data/xiaoyukou/LLM_Inference/data/small_test.json", help="The path of the test data.")
